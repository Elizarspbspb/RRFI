...
bool ETSI_RRS_RRFI::tx_from_buff(std::vector<std::complex<float>> buff, size_t samps_per_buff = 100) {
...
std::vector<std::complex<float>> ETSI_RRS_RRFI::rx_to_buff(size_t samps_per_buff, float settling_time, int num_requested_samps = 0) {
