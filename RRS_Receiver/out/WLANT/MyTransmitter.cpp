...
static void MyReceiver(std::vector<std::complex<float>> fxp_time_signal, unsigned int num_of_samples, char* param, char bufout[])
{
    time_t sec;
    sec = time (NULL);
    ...
    auto *Mybuff5 = new std::complex<float> [num_of_samples*8];
