...
static std::vector<std::complex<float>> simulate(double SNR, unsigned packet_size, unsigned data_rate, int channel_type, int use_ldpc, int packet_count, unsigned int *num_of_samples2, const char buf[]);
...
static std::vector<std::complex<float>> MyTransmitter(char* param, unsigned int *num_of_samples2, char buf[])
{
...
static std::vector<std::complex<float>> simulate(double SNR, unsigned packet_size, unsigned data_rate, int channel_type, int use_ldpc, int packet_count, unsigned int *num_of_samples2, const char buf[])
{
    ...
    auto *time_signal = new std::complex<float> [MaxPacketSize];
