...
//							fxp_params.AGC_precision-1,
   ...
   /* VrmsAddr=__max((int)0, round(RMS*128.0/RMS_MAX_int)-1 ); // Compute VrmsAddr accordung to RMS level
    VrmsAddr=__min(VrmsAddr, 127);

    *gain=__max(0, __min(*gain+AGCAddrModLUT[VrmsAddr],127)); //Compute changes in gain of AGC */
